            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-838px, 0px, 0px); transition: 0s; -webkit-transition: 0s; width: 2933px;"><div class="owl-item cloned" style="width: 409px; margin-right: 10px;"><div>
                                <img alt="" height="300" class="img-responsive" src="<?=base_url()?>assets/img/products/product-7-2.jpg">
                            </div></div><div class="owl-item cloned" style="width: 409px; margin-right: 10px;"><div>
                                <img alt="" height="300" class="img-responsive" src="<?=base_url()?>assets/img/products/product-7-3.jpg">
                            </div></div><div class="owl-item active" style="width: 409px; margin-right: 10px;"><div>
                                <img alt="" height="300" class="img-responsive" src="<?=base_url()?>assets/img/products/product-7.jpg">
                    ...
                    <div class="col-md-12">
                        <div class="tabs tabs-product">
                            <ul class="nav nav-tabs">
                                <li class=""><a href="#productDescription" data-toggle="tab" aria-expanded="false">Description</a></li>
                                <li class=""><a href="#productInfo" data-toggle="tab" aria-expanded="false">Aditional Information</a></li>
                            </ul>
                                        ...
                                        <li>
                                            <div class="comment">
                                                <div class="img-thumbnail">
                                                    <img class="avatar" alt="" src="<?=base_url()?>assets/img/avatar-2.jpg">
                                                </div>
                                                <div class="comment-block">
                                                    <div class="comment-arrow"></div>
                                                    <span class="comment-by">
                                                        <strong>John Doe</strong>
                                                        <span class="pull-right shop">
                                                            <div title="Rated 5.00 out of 5" class="star-rating">
                                                                <span style="width:100%"><strong class="rating">5.00</strong> out of 5</span>
                                                            </div>
                                                        </span>
                    ...
                    <ul class="simple-post-list">
                            ...
                            <div class="post-image">
                                <div class="img-thumbnail">
                                    <a href="shop-product-sidebar.html">
                                        <img alt="" width="60" height="60" class="img-responsive" src="<?=base_url()?>assets/img/products/product-1.jpg">
                                    </a>
                                </div>
                            </div>
                            <div class="post-info">
                                <a href="shop-product-sidebar.html">Bone</a>
                                <div class="post-meta">
                                    $299
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="post-image">
                                <div class="img-thumbnail">
                                    <a href="shop-product-sidebar.html">
                                        <img alt="" width="60" height="60" class="img-responsive" src="<?=base_url()?>assets/img/products/product-2.jpg">
                                    </a>
                                </div>
                            </div>
                            <div class="post-info">
                                <a href="shop-product-sidebar.html">Sinjai</a>
                                <div class="post-meta">
                                    $72
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="post-image">
                                <div class="img-thumbnail">
                                    <a href="shop-product-sidebar.html">
                                        <img alt="" width="60" height="60" class="img-responsive" src="<?=base_url()?>assets/img/products/product-3.jpg">
                                    </a>
                                </div>
                            </div>
                            <div class="post-info">
                                <a href="shop-product-sidebar.html">Pinrang</a>
                                <div class="post-meta">
                                    $60
                                </div>
                            </div>

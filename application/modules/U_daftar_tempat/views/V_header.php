...
<html>
	<head>
		...
		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="<?=base_url()?>assets/ss/custom.css">
	...
	<body>
		<div class="body main shop" role="main">
					...
					<div class="header-row" >
						<div class="header-column">
							<div class="header-logo">
								<a href="index.html">
									<img alt="Porto" width="121" height="54" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?=base_url()?>assets/img/slides/logo.png">
								</a>
							</div>
							<div>
								<h2 style="margin-left: 10px; margin-top: 20px">KANTOR PEMESANAN</h2>
							</div>
						</div>
						<div class="header-column">
								...
								<li>
									<div class="feature-box feature-box-style-3">
										...
										<div class="feature-box-info">
											<h4 class="mb-none">Nurlisah</h4>
											<p><small>nurlisah@gmail.com</small></p>
										</div>
									</div>
								</li>
							</ul>
					...
					<div class="header-nav-main header-nav-main-light header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse">
						<nav>
							<ul class="nav nav-pills" id="mainNav">
								<li >
									<a href="u-beranda.html">
										Beranda
									</a>
								</li>
								<li class="active">
									<a href="u-daftar.html">
										Tempat Tersedia
									</a>
								</li>
								<li >
								...
								<li >
									<a href="u-provider.html">
										Provider
									</a>
								</li>
								<li >
									<a href="u-profil.html">
										Profil
									</a>
								</li>
								<li >
